...
import com.mztown.projectcasino.util.SystemUiHider;
...
public class mainhub extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainhubSetting.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ((ImageButton) v).setImageDrawable(getResources().getDrawable(R.drawable.setting_2));
        ...
        mainhubGame.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
